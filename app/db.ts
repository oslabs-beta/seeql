...
const getForeignKeys = (client: any, tableName: string) => {
  return new Promise((resolve, reject) => {
    client.query(
      `
      SELECT 
...
const getColumns = (client: any, tableName: string) => {
  return new Promise((resolve, reject) => {
    client.query(
      `
			SELECT 
...
const getPrimaryKey = (client: any, tableName: string) => {
  return new Promise((resolve, reject) => {
    client.query(
      `
			SELECT 
...
async function composeTableData(client: any): Promise<any> {
  let tablesArr = [];
